...
export default function ShopModal() {
    ...
    async function handleLessStock(e) {
        try {
            ...
            if(product.quantity === 1){
                let url = `https://proyecto-web-backend-host.onrender.com/shop/cart/deleteone/${product._id}`
                ...
                let url = `https://proyecto-web-backend-host.onrender.com/shop/cart/update/${product._id}`
    ...
    async function deleteOne(e, id) {
        try {
            ...
            let url = `https://proyecto-web-backend-host.onrender.com/shop/cart/deleteone/${productId}`
            await axios.delete(url, headers).then(res => toast.success(res.data.message))
            setReload(!reload)
        } catch (error) {
    ...
    function handlePay() {
        ...
        axios.post("https://proyecto-web-backend-host.onrender.com/payment", data, headers)
