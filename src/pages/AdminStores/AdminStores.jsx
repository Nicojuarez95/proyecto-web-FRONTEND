...
export default function AdminStores() {
    ...
    async function getUsers() {
        let url = `https://proyecto-web-backend-host.onrender.com/admin/users/`
        if (token) {
    ...
    async function getShops() {
        if (search.current) {
            let url = `https://proyecto-web-backend-host.onrender.com/admin/shops/?name=${search.current.value}&category=${selectedCategorie}`
            await axios.get(url, headers).then(res => {
    ...
    async function deleteOne(e) {
        ...
        let userId = user._id
        let url = `https://proyecto-web-backend-host.onrender.com/admin/shops/delete/${shopId}/${userId}`
    ...
    async function desactivateOne(e) {
        let shopId = e.target.id
        let url = `https://proyecto-web-backend-host.onrender.com/admin/shops/desactivate/${shopId}`
